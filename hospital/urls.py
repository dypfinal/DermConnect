...
urlpatterns = [
    ...
    path(
        "admit_details/<int:pk>",
        views.admit_details_particular_view,
        name="admit_details_particular.html",
    ),
    path(
        "bookapp_details_pat/<int:pk>",
        views.appointment_details_particular_pat_view,
        name="bookapp_details_particular_pat.html",
    ),
    path(
        "endappointment_doc/<int:pk>",
        views.endappointment_doc_view,
        name="endappointment_doc",
    ),
    ...
    path(
        "dash_doc/<int:pk>", views.dash_doc_approve_view, name="dashboard_doc_approve"
    ),
    path(
        "admit_details_doc/",
        views.admit_details_doc_view,
        name="admit_details_doc.html",
    ),
    path(
        "admit_details_doc/<int:pk>",
        views.admit_details_particular_doc_view,
        name="admit_details_particular_doc.html",
    ),
    path(
        "admit_details_doc/<int:pk>/<str:comm>/<int:quan>",
        views.admit_details_particular_doc_add_charge_view,
        name="admit_details_particular_doc_add_charge",
    ),
    ...
    path(
        "bookapp_doc/<int:pk>/<str:link>", views.bookapp_doc_link_view, name="add_link"
    ),
    path(
        "bookapp_doc/<int:pk>",
        views.appointment_details_particular_doc_view,
        name="bookapp_details_particular_doc.html",
    ),
    path(
        "bookapp_doc/<int:pk>/<str:comm>/<int:quan>",
        views.appointment_details_particular_doc_add_charge_view,
        name="appointment_details_particular_doc_add_charge",
    ),
    ...
    path(
        "medicalreport_adm/",
        views.medicalreport_adm_view,
        name="medicalreport_adm.html",
    ),
    ...
    path(
        ...
        name="appoint_view_adm.html",
    ),
    path(
        "appointment_particular_adm/<int:pk>",
        views.appointment_particular_adm_view,
        name="appoint_particular_adm.html",
    ),
    path("admin_admit_view", views.admin_admit_view, name="admit_view_adm.html"),
    path(
        "admin_admit_view/<int:pk>",
        views.admit_particular_adm_view,
        name="admit_particular_adm.html",
    ),
    path(
        "pat_appointment_view", views.pat_appointment_view, name="appoint_view_pat.html"
    ),
    ...
    path(
        "logout/",
        auth_views.LogoutView.as_view(template_name="hospital/logout.html"),
        name="logout",
    ),
    path(
        "password_reset/",
    ...
    path(
        ...
        auth_views.PasswordResetDoneView.as_view(
            template_name="hospital/password_reset_done.html"
        ),
    ...
    path(
        ...
        auth_views.PasswordResetConfirmView.as_view(
            template_name="hospital/password_reset_confirm.html"
        ),
    ...
    path(
        ...
        auth_views.PasswordResetCompleteView.as_view(
            template_name="hospital/password_reset_complete.html"
        ),
    ...
    path(
        "downloadreport/<int:pk>", views.render_pdf_report_view, name="downloadreport"
    ),
    path("downloadbill/<int:pk>", views.render_pdf_bill_view, name="downloadbill"),
    path(
        "downloadreport_apt/<int:pk>",
        views.render_pdf_report_apt_view,
        name="downloadreport_apt",
    ),
    path(
        "downloadbill_apt/<int:pk>",
        views.render_pdf_bill_apt_view,
        name="downloadbill_apt",
    ),
]
